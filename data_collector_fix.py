# Add this method to data_collector.py around line 450 (after get_vegas_odds_data)
...
async def filter_vegas_to_csv_games(self, vegas_data: Dict, csv_games: List[str]) -> Dict:
    ...
    logger.info(f"🎯 CSV has {len(csv_games)} games: {csv_games}")
...
def _create_estimated_vegas_from_csv(self, csv_games: List[str]) -> Dict:
    ...
    for game in csv_games:
        ...
        high_scoring_teams = ['KC', 'BUF', 'DAL', 'DET', 'SF', 'MIA', 'LAR']
