...
async def read_root():
    ...
    <head>
        ...
        <style>
            * { box-sizing: border-box; }
            ...
            .insights-card pre { margin: 0; font-size: 11px; white-space: pre-wrap; color: #aaa; max-height: 100px; overflow-y: auto; }
    ...
    <body>
        ...
        <script>
            ...
            const POSITION_ORDER = ['QB', 'RB', 'WR', 'TE', 'DEF', 'D'];
            const POSITION_NAMES = { 'QB': 'Quarterbacks', 'RB': 'Running Backs', 'WR': 'Wide Receivers', 'TE': 'Tight Ends', 'DEF': 'Defense', 'D': 'Defense' };
            ...
            function renderPlayersByPosition(filter = '') {
                ...
                POSITION_ORDER.forEach(pos => {
                    ...
                    if (pos === 'D') players = playersByPosition['DEF'] || players;
            ...
            function updateAIInsights(recommendations) {
                ...
                if (recommendations && Object.keys(recommendations).length > 0) {
                    ...
                    pre.textContent = JSON.stringify(recommendations, null, 2);
                } else {
